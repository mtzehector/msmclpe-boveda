...
@Log
@Provider
public class LoadBovedaV3Service extends ServiceDefinition<CreateDocumentReq, CreateDocumentReq> {
    ...
    public Message<CreateDocumentReq> execute(Message<CreateDocumentReq> request) throws BusinessException {
        ...
        try {
            DocumentRes res  = service.recuperarDocumentoBovedaV3(reporteIn);
